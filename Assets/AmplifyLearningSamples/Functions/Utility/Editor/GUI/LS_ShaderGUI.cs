    ...
    void DrawDynamicInspector(Material material, MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        for (int i = 0; i < props.Length; i++)
        {
            ...
            if (prop.name == "_GlossyReflections")
                continue;
            if (prop.name == "_EnvironmentReflections")
                continue;
            if (prop.name == "_ReceiveShadows")
                continue;
            if (prop.name == "_XRMotionVectorsPass")
                continue;
        ...
        if (showAdvanced)
        {
            ...
            #region [URP Screen Space Reflection _ScreenSpaceReflections]
            if (material.GetTag("RenderPipeline", false) == "UniversalPipeline")
                if (material.HasProperty("_ScreenSpaceReflections"))
                {
                    if (material.HasProperty("_ScreenSpaceReflections"))
                    {
                        var control = material.GetInt("_ScreenSpaceReflections");
                        ...
                        toggle = EditorGUILayout.Toggle("Screen Space Reflections", toggle);

                        if (toggle)
                        {
                            material.SetInt("_ScreenSpaceReflections", 1);
                            material.DisableKeyword("_SCREENSPACEREFLECTIONS_OFF");
                        }
                        else
                        {
                            material.SetInt("_ScreenSpaceReflections", 0);
                            material.EnableKeyword("_SCREENSPACEREFLECTIONS_OFF");
                        }
                    }
                }
            #endregion [URP Screen Space Reflection _ScreenSpaceReflections]

            #region [URP Screen Space Reflection Transparent _ScreenSpaceReflectionsContributeTransparent]
            if (material.GetTag("RenderPipeline", false) == "UniversalPipeline")
                if (material.HasProperty("_ScreenSpaceReflectionsContributeTransparent"))
                {
                    if (material.HasProperty("_ScreenSpaceReflectionsContributeTransparent"))
                    {
                        var control = material.GetInt("_ScreenSpaceReflectionsContributeTransparent");
                        ...
                        toggle = EditorGUILayout.Toggle("Screen Space Reflections Contribute Transparent", toggle);

                        if (toggle)
                        {
                            material.SetInt("_ScreenSpaceReflectionsContributeTransparent", 1);
                            material.DisableKeyword("_SCREENSPACEREFLECTIONSCONTRIBUTETRANSPARENT_OFF");
                        }
                        else
                        {
                            material.SetInt("_ScreenSpaceReflectionsContributeTransparent", 0);
                            material.EnableKeyword("_SCREENSPACEREFLECTIONSCONTRIBUTETRANSPARENT_OFF");
                        }
                    }
                }
            #endregion [URP Screen Space Reflection Transparent _ScreenSpaceReflectionsContributeTransparent]
            ...
            #region [URP XR Motion Vectors]
            if (material.GetTag("RenderPipeline", false) == "UniversalPipeline")
                if (material.HasProperty("_XRMotionVectorsPass"))
                {
                    if (material.HasProperty("_XRMotionVectorsPass"))
                    {
                        var control = material.GetInt("_XRMotionVectorsPass");
                        ...
                        toggle = EditorGUILayout.Toggle("XR Motion Vectors", toggle);

                        if (toggle)
                        {
                            material.SetInt("_XRMotionVectorsPass", 1);
                        }
                        else
                        {
                            material.SetInt("_XRMotionVectorsPass", 0);
                        }
                    }
                }
            #endregion [URP XR Motion Vectorsy]
