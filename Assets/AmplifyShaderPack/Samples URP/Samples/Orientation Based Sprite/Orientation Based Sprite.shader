	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult36_g11 = (float2(( ( floor( ( ( atan2( break11_g11.z , break11_g11.x ) + PI ) / ( TWO_PI / temp_output_41_0_g11 ) ) ) * temp_output_28_0_g11 ) + ( temp_output_28_0_g11 * break44_g11.x ) ) , (( ( break44_g11.y + ( temp_output_45_0_g11 - fmod( ( 1.0 + round( ( _AnimSpeed * ( _TimeParameters.x ) ) ) ) , temp_output_45_0_g11 ) ) ) / temp_output_45_0_g11 )).x));
				float2 vertexToFrag37_g11 = appendResult36_g11;
				output.ase_texcoord1.xy = vertexToFrag37_g11;
						 ...
						 )
			{
				...
				float2 vertexToFrag37_g11 = input.ase_texcoord1.xy;
				float4 temp_output_634_0 = tex2D( _MainTex, vertexToFrag37_g11 );
...
ASEEND*/
//CHKSM=476A7B64B4A6696EE14588D71AFF0407191F6166