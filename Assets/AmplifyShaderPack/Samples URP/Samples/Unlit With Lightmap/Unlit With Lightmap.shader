	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord2_g6 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 vertexToFrag10_g6 = ( ( texCoord2_g6 * (unity_LightmapST).xy ) + (unity_LightmapST).zw );
				output.ase_texcoord3.zw = vertexToFrag10_g6;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_30_0 = (tex2D( _MainTex, uv_MainTex )).rgb;
				
				float2 vertexToFrag10_g6 = input.ase_texcoord3.zw;
				...
				float4 appendResult8 = (float4(( decodeLightMap6_g6 * temp_output_30_0 ) , 1.0));
				
				float3 BakedAlbedo = temp_output_30_0;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord2_g6 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 vertexToFrag10_g6 = ( ( texCoord2_g6 * (unity_LightmapST).xy ) + (unity_LightmapST).zw );
				output.ase_texcoord3.xy = vertexToFrag10_g6;
								 ...
								 )
			{
				...
				float2 vertexToFrag10_g6 = input.ase_texcoord3.xy;
				float2 UV11_g6 = vertexToFrag10_g6;
				float4 localSampleLightmapHD11_g6 = SampleLightmapHD11_g6( UV11_g6 );
				float4 localURPDecodeInstruction19_g6 = URPDecodeInstruction19_g6();
				float3 decodeLightMap6_g6 = DecodeLightmap(localSampleLightmapHD11_g6,localURPDecodeInstruction19_g6);
				float2 uv_MainTex = input.ase_texcoord3.zw * _MainTex_ST.xy + _MainTex_ST.zw;
				float3 temp_output_30_0 = (tex2D( _MainTex, uv_MainTex )).rgb;
				float4 appendResult8 = (float4(( decodeLightMap6_g6 * temp_output_30_0 ) , 1.0));
...
ASEEND*/
//CHKSM=6BD155CCE02167F62EDE5660F9517A66812A08A2