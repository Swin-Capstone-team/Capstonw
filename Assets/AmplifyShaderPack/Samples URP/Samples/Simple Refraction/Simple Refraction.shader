	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_RefractionMap = input.ase_texcoord3.xy * _RefractionMap_ST.xy + _RefractionMap_ST.zw;
...
ASEEND*/
//CHKSM=20D2287B929921C961DFF22EEB3E6F9417C3AE9C