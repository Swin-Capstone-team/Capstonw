		...
		Pass
		{
			...
			CGPROGRAM
							...
							) : SV_Target
				{
					...
					half Metallic = tex2D( _Metallic, uv_Metallic ).rgb.x;
					half Smoothness = 0;
					half Occlusion = tex2D( _Occlusion, uv_Occlusion ).rgb.x;
...
WireConnection;34;4;2;5
WireConnection;34;6;4;5
WireConnection;34;2;27;0
ASEEND*/
//CHKSM=56AB5ADFAAC3F45A01071BB36AEB08D11EF81284