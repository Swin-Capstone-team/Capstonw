		...
		Pass
		{
			...
			CGPROGRAM
							...
							) : SV_Target
				{
					...
					float2 appendResult336 = (float2(IN.ase_texcoord6.xyz.y , IN.ase_texcoord6.xyz.z));
					float3 temp_output_72_0 = abs( mul( unity_WorldToObject, float4( NormalWS , 0.0 ) ).xyz );
					float dotResult73 = dot( temp_output_72_0 , float3( 1, 1, 1 ) );
					float3 BlendComponents147 = ( temp_output_72_0 / dotResult73 );
					float2 appendResult335 = (float2(IN.ase_texcoord6.xyz.x , IN.ase_texcoord6.xyz.z));
					float2 appendResult334 = (float2(IN.ase_texcoord6.xyz.x , IN.ase_texcoord6.xyz.y));
					float WorldObjectSwitch192 = _WorldtoObjectSwitch;
					float3 lerpResult187 = lerp( PositionWS , IN.ase_texcoord6.xyz , WorldObjectSwitch192);
					float3 break287 = lerpResult187;
					float2 appendResult333 = (float2(break287.x , break287.z));
					float2 appendResult332 = (float2(IN.ase_texcoord6.xyz.y , IN.ase_texcoord6.xyz.z));
					float2 appendResult331 = (float2(IN.ase_texcoord6.xyz.x , IN.ase_texcoord6.xyz.z));
					float2 appendResult330 = (float2(IN.ase_texcoord6.xyz.x , IN.ase_texcoord6.xyz.y));
					float2 uv_TopNormal = IN.ase_texcoord7.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
		...
		Pass
		{
			...
			CGPROGRAM
					...
					) : SV_Target
				{
					...
					float2 appendResult336 = (float2(IN.ase_texcoord5.xyz.y , IN.ase_texcoord5.xyz.z));
					float3 temp_output_72_0 = abs( mul( unity_WorldToObject, float4( NormalWS , 0.0 ) ).xyz );
					float dotResult73 = dot( temp_output_72_0 , float3( 1, 1, 1 ) );
					float3 BlendComponents147 = ( temp_output_72_0 / dotResult73 );
					float2 appendResult335 = (float2(IN.ase_texcoord5.xyz.x , IN.ase_texcoord5.xyz.z));
					float2 appendResult334 = (float2(IN.ase_texcoord5.xyz.x , IN.ase_texcoord5.xyz.y));
					float WorldObjectSwitch192 = _WorldtoObjectSwitch;
					float3 lerpResult187 = lerp( PositionWS , IN.ase_texcoord5.xyz , WorldObjectSwitch192);
					float3 break287 = lerpResult187;
					float2 appendResult333 = (float2(break287.x , break287.z));
		...
		Pass
		{
			...
			CGPROGRAM
				...
				)
				{
					...
					float WorldObjectSwitch192 = _WorldtoObjectSwitch;
					float3 lerpResult187 = lerp( PositionWS , IN.ase_texcoord4.xyz , WorldObjectSwitch192);
					float3 break287 = lerpResult187;
					float2 appendResult333 = (float2(break287.x , break287.z));
					...
					float2 uv_TopNormal = IN.ase_texcoord5.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
					float3 lerpResult284 = lerp( ( ( ( UnpackNormal( tex2D( _TriplanarNormal, appendResult332 ) ) * BlendComponents147.x ) + ( UnpackNormal( tex2D( _TriplanarNormal, appendResult331 ) ) * BlendComponents147.y ) ) + ( UnpackNormal( tex2D( _TriplanarNormal, appendResult330 ) ) * BlendComponents147.z ) ) , UnpackNormal( tex2D( _TopNormal, uv_TopNormal ) ) , pow( saturate( ( NormalWS.y + _CoverageAmount ) ) , _CoverageFalloff ));
					float3 CalculatedNormal292 = lerpResult284;
					float3 tanToWorld0 = float3( TangentWS.x, BitangentWS.x, NormalWS.x );
					float3 tanToWorld1 = float3( TangentWS.y, BitangentWS.y, NormalWS.y );
		...
		Pass
		{
			...
			CGPROGRAM
				...
				half4 frag( v2f IN  ) : SV_Target
				{
					...
					float WorldObjectSwitch192 = _WorldtoObjectSwitch;
					float3 lerpResult187 = lerp( ase_positionWS , IN.ase_texcoord2.xyz , WorldObjectSwitch192);
					float3 break287 = lerpResult187;
					float2 appendResult333 = (float2(break287.x , break287.z));
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;170;-524.7089,1125.127;Inherit;False;436.2993;336.8007;Coverage in Object mode;3;149;328;313;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;292;1216,2288;Float;True;CalculatedNormal;2;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;338;1;292;0
WireConnection;338;3;212;0
WireConnection;338;5;213;0
ASEEND*/
//CHKSM=B98AA661986EF40FB5E023A4149C7579C42AF3F1